...
export default {
    ...
    methods: {
        ...
        initVol () {
            const $volBox = this.$el.getElementsByClassName('wui-contrl-vol-slider')[0]
            const $volInner = $volBox.getElementsByClassName('wui-contrl-vol-inner')[0]
        ...
        initVideo () {
            const $videoSlider = this.$el.getElementsByClassName('wui-contrl-video-slider')[0]
            const $videoInner = $videoSlider.getElementsByClassName('wui-contrl-video-inner')[0]
