<template>
    <div>
        <div class="wui-datetime-mask" v-show="show" @click.stop="close"></div>
        <div class="wui-datetime" :class="show ? 'wui-datetime-active' : ''">
            <div class="wui-datetime-head">
            ...
            <div class="wui-datetime-content">
                ...
                <div class="wui-datetime-shade"></div>
                <div class="wui-datetime-indicator"><span></span></div>
            </div>
        </div>
    </div>
</template>
  ...
  methods: {
    ...
    scrolloToPosition(type, allDatas, callback) {
      ...
      scroller.setDimensions(
        _this.$refs['Component_' + type][0].clientHeight,
        _this.$refs['Content_' + type][0].offsetHeight,
        allDatas.length
      )
