...
export default class QArt {
  ...
  make (el) {
    ...
    qrImage.onload = function () {
      ...
      var imageCanvas = Util.createCanvas(el, imageSize - padding * 2, coverImage, self.fillType)
      coverImage.src = imageCanvas.toDataURL()

      var resultCanvas = Util.createCanvas(el, imageSize, qrImage, 'fill', self.type === 'mix')
      var qrCanvas = Util.createCanvas(el, imageSize, qrImage, 'fill', self.type === 'default')

      if (typeof self.background !== 'undefined') {
        var bgCanvas = Util.createCanvas(el, self.size, new Image())
      ...
      coverImage.onload = function () {
        ...
        var coverCanvas = Util.createCanvas(el, imageSize)
        ...
        var scaledCanvas = Util.createCanvas(el, self.size, new Image())
        if (typeof self.background !== 'undefined') {
